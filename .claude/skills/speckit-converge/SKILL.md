...
- [Execution Steps](#execution-steps)
  - [1. Initialize Convergence Context](#1-initialize-convergence-context)
  - [2. Load Artifacts (Progressive Disclosure)](#2-load-artifacts-progressive-disclosure)
  - [3. Build the Intent Inventory](#3-build-the-intent-inventory)
  - [4. Assess the Codebase and Classify Findings](#4-assess-the-codebase-and-classify-findings)
  - [5. Assign Severity](#5-assign-severity)
  - [6. Present the In-Session Findings Summary](#6-present-the-in-session-findings-summary)
- [Convergence Findings](#convergence-findings)
  - [7. Append Convergence Tasks (or report converged)](#7-append-convergence-tasks-or-report-converged)
  - [8. Provide Next Actions (Handoff)](#8-provide-next-actions-handoff)
  - [9. Check for extension hooks](#9-check-for-extension-hooks)
