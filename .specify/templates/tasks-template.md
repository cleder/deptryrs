...
- [Tasks: [FEATURE NAME]](#tasks-feature-name)
  ...
  - [Phase 3: User Story 1 - [Title] (Priority: P1) 🎯 MVP](#phase-3-user-story-1---title-priority-p1--mvp)
    - [Tests for User Story 1 (OPTIONAL - only if tests requested) ⚠️](#tests-for-user-story-1-optional---only-if-tests-requested-)
  ...
  - [Phase 4: User Story 2 - [Title] (Priority: P2)](#phase-4-user-story-2---title-priority-p2)
    - [Tests for User Story 2 (OPTIONAL - only if tests requested) ⚠️](#tests-for-user-story-2-optional---only-if-tests-requested-)
  ...
  - [Phase 5: User Story 3 - [Title] (Priority: P3)](#phase-5-user-story-3---title-priority-p3)
    - [Tests for User Story 3 (OPTIONAL - only if tests requested) ⚠️](#tests-for-user-story-3-optional---only-if-tests-requested-)
